    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-5 pb-16 pt-8 md:px-8 md:pb-24 md:pt-12">
        ...
        <article className="mt-8">
          <div className="text-[11px] font-bold text-[var(--brand-strong)]">
            {article.category}
          </div>
          <h1 className="mt-3 max-w-3xl text-3xl font-bold tracking-tight text-slate-950 dark:text-slate-50 md:text-[2.7rem] md:leading-[1.08]">
            {article.title}
          </h1>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-3">
              {relatedArticles.map((item) => (
                ...
                >
                  ...
                  <h3 className="mt-2 break-keep text-sm font-bold leading-6 text-slate-950 group-hover:text-[var(--brand-strong)] dark:text-slate-50">
                    {item.title}
                  </h3>
                </Link>
              ))}
