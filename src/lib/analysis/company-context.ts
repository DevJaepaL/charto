...
const CONTEXT_RULES: CompanyContextRule[] = [
  ...
  {
    match: /(삼성전자|하이닉스|반도체|DB하이텍|한미반도체|주성엔지니어링|원익|리노공업|ISC|가온칩스|텔레칩스|칩스앤미디어|유진테크|네패스|뉴파워프라즈마)/,
    sector: "반도체",
...
const OFFICIAL_CONTEXT_RULES: OfficialContextRule[] = [
  ...
  },
  {
    match: /^29271/,
    sector: "반도체",
    businessSummary: "반도체 공정 장비와 핵심 모듈 수요, 고객사 설비투자, 업황 회복 기대가 실적에 직접 반영되는 업종입니다.",
    industryFlow: "반도체 장비주는 메모리 업황, 전공정 투자, 고객사 CAPEX 흐름이 살아날 때 심리가 빠르게 개선되는 편입니다.",
    marketPosition: "반도체 투자 사이클과 함께 움직이는 장비·부품 성격이 강해 업황 회복 기대가 붙을수록 재평가가 빨라질 수 있습니다.",
  },
  {
    match: /^29272/,
    sector: "디스플레이",
    businessSummary: "디스플레이 공정 장비와 패널 투자, 고객사 증설 흐름이 실적에 반영되는 장비 업종입니다.",
    industryFlow: "패널 업황과 설비투자 회복 기대가 살아날 때 장비주 수급도 함께 개선되는 편입니다.",
    marketPosition: "디스플레이 투자 사이클 영향을 크게 받아 업황 반등 기대와 함께 평가하는 편이 좋습니다.",
  },
  {
    match: /^29280/,
    sector: "로봇·자동화",
    businessSummary: "산업용 로봇과 자동화 설비 수요, 제조업 투자 확대 기대가 실적과 가치 평가에 반영되는 업종입니다.",
    industryFlow: "자동화 투자와 스마트팩토리 기대가 붙을 때 업종 전체로 매수세가 확산되기 쉽습니다.",
    marketPosition: "장기 성장 스토리는 유효하지만 단기 기대 과열도 잦아 실적과 수주 흐름을 함께 보는 편이 좋습니다.",
    interpretWithCaution: true,
  },
  {
    match: /^29/,
    sector: "기계·장비",
    businessSummary: "설비 투자와 수주, 산업 경기 회복 기대가 기업 가치에 직접 연결되는 기계·장비 업종입니다.",
    industryFlow: "CAPEX 회복과 자동화 투자 기대가 살아날 때 업종 심리가 개선되기 쉽습니다.",
    marketPosition: "세부 품목이 매우 넓어 일반론보다는 실제 장비 용도와 고객사를 함께 보는 편이 좋습니다.",
    confidence: "medium",
    interpretWithCaution: true,
  },
  {
